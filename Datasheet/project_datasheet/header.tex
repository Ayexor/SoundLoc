...
\title{-- Digital Microelectronics --- SoundLoc -- \\ Localization of sound sources by cross-correlating \\ three $\Sigma\Delta$-microphone signals}
...
\usepackage[
	...
	pdfsubject={Sound localization using cross-correlation of three microphones},		%Thema des PDF Dokuments.
	pdfcreator={LaTeX with hyperref and KOMA-Script},		%Erzeuger des PDF Dokuments.
	pdfkeywords={Cross-correlating, CIC, IP, AXI4\_Lite interface},						%auch für PDF Dokumente indexiert
