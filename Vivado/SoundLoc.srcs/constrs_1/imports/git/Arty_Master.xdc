...
set_property -dict {PACKAGE_PIN E15 IOSTANDARD LVCMOS33} [get_ports {micClk[0]}]
set_property -dict {PACKAGE_PIN E16 IOSTANDARD LVCMOS33} [get_ports mic1]
set_property -dict {PACKAGE_PIN D15 IOSTANDARD LVCMOS33} [get_ports mic2]
set_property -dict {PACKAGE_PIN C15 IOSTANDARD LVCMOS33} [get_ports mic3]
...
set_property -dict {PACKAGE_PIN U12 IOSTANDARD LVCMOS33} [get_ports shRstn]
set_property -dict {PACKAGE_PIN V12 IOSTANDARD LVCMOS33} [get_ports shClk]
set_property -dict {PACKAGE_PIN V10 IOSTANDARD LVCMOS33} [get_ports shStr]
set_property -dict {PACKAGE_PIN V11 IOSTANDARD LVCMOS33} [get_ports shData]
