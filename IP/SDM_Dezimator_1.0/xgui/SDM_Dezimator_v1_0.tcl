...
proc init_gui { IPINST } {
  ...
  set_property tooltip {The internal with of the filter. Defines the width of Integrator and comb stage as well as the dezimation counter. Must be less or equal to C_S_AXI_DATA_WIDTH} ${D_WIDTH}
